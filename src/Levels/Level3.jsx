    ...
    return (<div>
        ...
        <div className='h-[100vh] bg-purple-400 p-[50px]'>
            ...
            <div className='h-[100%] bg-slate-400'>
                ...
                <div className='bg-white h-[50px] w-[800px] top-[100px] absolute'>

                </div>
                <div className='bg-white h-[50px] w-[800px] top-[150px] absolute'>

                </div>
                <div className='bg-white h-[50px] w-[800px] top-[200px] absolute'>

                </div>
                <div className='bg-white h-[50px] w-[800px] top-[250px] absolute'>

                </div>
                <div className='bg-white h-[50px] w-[800px] top-[300px] absolute'>

                </div>
                <div className='bg-white h-[50px] w-[800px] top-[350px] absolute'>

                </div>
                <div className='bg-white h-[50px] w-[800px] top-[400px] absolute'>

                </div>
                <div className='bg-white h-[50px] w-[800px] top-[450px] absolute'>
